        ...
        <Grid container direction="column" spacing={2}>
          <Grid item >
            ...
            <Typography
              ...
              color="#737C88"
            >
             {email && ('Acabamos de enviar um código para o e-mail '+ email + '.' )}
            </Typography>
          </Grid>
          <Grid item marginTop={4}>
            <TextField value={token} onChange={(e)=>setToken(e.target.value)} fullWidth variant="standard" label="Codigo" placeholder='******' />
          </Grid>
          
          <Grid item display="flex" alignItems="flex-end" justifyContent="flex-end" mt={5}>
            <Button onClick={()=>handleClickVerifyToken()}variant='contained' size="small" sx={{textTransform: "capitalize", width: 100}}>Entrar</Button>
          </Grid>
        </Grid>
        </Box>
			</BaseLoginLayout>
